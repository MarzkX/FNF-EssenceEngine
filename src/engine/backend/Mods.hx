...
class Mods
{
	...
	static public function getCurrentMod():String
	...
	inline public static function mergeAllTextsNamed(path:String, defaultDirectory:String = null, allowDuplicates:Bool = false)
	{
		...
		if(!defaultDirectory.startsWith('funkin/')) defaultDirectory = 'funkin/$defaultDirectory';
	...
	inline public static function directoriesWithFile(path:String, fileToFind:String, mods:Bool = true)
	{
		...
		#else
		if(openfl.Assets.exists(path + fileToFind))
		#end
	...
	inline public static function parseList():ModsList {
		...
		#if MODS_ALLOWED
		try {
			for (mod in CoolUtil.coolTextFile('bin/modsList.txt'))
			{
				//trace('Mod: $mod');
	...
	private static function updateModList()
	{
		...
		File.saveContent('bin/modsList.txt', fileStr);
		updatedOnState = true;
