...
import engine.shaders.RGBPalette.RGBShaderReference;
...
class NotesSubState extends MusicBeatSubstate
{
	...
	public function new() {
		...
		modeBG = FlxSpriteUtil.drawRoundRect(new FlxSprite(215, 85).makeGraphic(315, 115, FlxColor.TRANSPARENT), 0, 0, 315, 115, 15, 15, FlxColor.BLACK);
		modeBG.visible = false;
		modeBG.alpha = 0.4;
		add(modeBG);

		notesBG = FlxSpriteUtil.drawRoundRect(new FlxSprite(140, 190).makeGraphic(480, 125, FlxColor.TRANSPARENT), 0, 0, 480, 125, 15, 15, FlxColor.BLACK);
		...
		bg.alpha = 0.25;
		add(bg);
		var bg:FlxSprite = FlxSpriteUtil.drawRoundRect(new FlxSprite(750, 160).makeGraphic(FlxG.width - 780, 540, FlxColor.TRANSPARENT), 0, 0, FlxG.width-780, 540, 15, 15, FlxColor.BLACK);
		bg.alpha = 0.25;
		add(bg);
