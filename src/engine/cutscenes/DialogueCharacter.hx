...
class DialogueCharacter extends FlxSprite
{
	...
	public function reloadCharacterJson(character:String) {
		var characterPath:String = 'data/jsonData/dialogue/' + character + '.json';
		var rawJson = null;
		...
		if(!FileSystem.exists(path)) {
			path = Paths.getSharedPath('data/jsonData/dialogue/' + DEFAULT_CHARACTER + '.json');
		}
