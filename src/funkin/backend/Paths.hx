...
class Paths
{
	...
	public static function getBin(file:String, type:AssetType, ?library:Null<String> = null)
	{
		if (library != null)
			return getOtherPath(file, library);

		if (currentLevel != null)
		{
			var levelPath:String = getBinPathForce(file, currentLevel);
			if (OpenFlAssets.exists(levelPath, type))
				return levelPath;
		}

		return getBinPath(file);
	}
	...
	static public function getSharedPath(file:String = '') //for no errors
		return 'funkin/$file';

	static public function getPreloadPath(file:String = '') //for no errors
		return 'funkin/$file';

	static public function getBinPath(file:String = '')
		return 'bin/$file';

	static public function getOtherPath(file:String, ?library:String)
		return getBinPathForce(file, library);

	inline static function getBinPathForce(file:String, library:String = '')
	{
		var returnPath = '$library:bin/$library/$file';
		return returnPath;
	}
	...
	inline static function getLibraryPathForce(file:String, library:String = 'mainFiles')
	{
		var returnPath = '$library:funkin/$library/$file';
		return returnPath;
	}
	...
	inline static public function txtBin(key:String, ?library:String)
	{
		return getBin('$key.txt', TEXT, library);
	}
	...
	static public function video(key:String)
	{
		...
		#end
		return 'funkin/videos/$key.$VIDEO_EXT';
	}
	...
	inline static public function getAsepriteAtlas(key:String, ?library:String = null, ?allowGPU:Bool = true):FlxAtlasFrames
	{
		...
		return FlxAtlasFrames.fromTexturePackerJson(imageLoaded, (jsonExists ? File.getContent(json) : getPath('images/$key.json', TEXT, library)));
		#else
		return FlxAtlasFrames.fromTexturePackerJson(imageLoaded, getPath('images/$key.json', TEXT, library));
		#end
	}
