...
@:access(funkin.vis.dsp.SpectralAnalyzer)
class ABotVis extends FlxTypedSpriteGroup<FlxSprite>
{
  ...
  public function new(snd:FlxSound)
  {
    ...
    var visFrms:FlxAtlasFrames = Paths.getSparrowAtlas('stuff/aBotViz');
  ...
  {
    @:privateAccess
    analyzer = new SpectralAnalyzer(7, new LimeAudioClip(cast snd._channel.__audioSource), 0.01, 30);
    analyzer.maxDb = -35;
    // analyzer.fftN = 2048;
  }
  ...
  {
    //this working ONLY in html5! (( - mrzk
    #if lime_howlerjs
