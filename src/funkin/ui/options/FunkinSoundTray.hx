...
class FunkinSoundTray extends FlxSoundTray
{
  ...
  public function new()
  {
    ...
    var bg:Bitmap = new Bitmap(Assets.getBitmapData(Paths.file('soundtray/volumebox.png', IMAGE, 'ingame')));
    ...
    var backingBar:Bitmap = new Bitmap(Assets.getBitmapData(Paths.file("soundtray/bars_10.png", IMAGE, 'ingame')));
    backingBar.x = 9;
    backingBar.y = 5;
    ...
    for (i in 1...11)
    {
      var bar:Bitmap = new Bitmap(Assets.getBitmapData(Paths.file('soundtray/bars_$i.png', IMAGE, 'ingame')));
      bar.x = 9;
      bar.y = 5;
