...
function onUpdate(dt)
	...
	local pix = song_camPixels
	local pix2 = song_camPixels * .45
...
function onUpdatePost(dt)
	...
	if song_camSmooth then
		...
		local smooth = ((1 / song_camSmoothIntensity) + 1)
		...
		camZoom = song_camSmooth and math.lerp(camZoom, realCamZoom, math.clamp(dt * 3.125 * camZoomingDecay * smooth, 0, 1)) or realCamZoom
